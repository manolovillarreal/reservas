...
export const useInquiriesStore = defineStore('inquiries', () => {
  ...
  const createInquiry = async (payload) => {
    ...
    const inquiryPayload = {
      ...
      guest_nationality: payload.guest_nationality || null,
      guest_gender: payload.guest_gender || null,
      guest_birth_date: payload.guest_birth_date || null,
      guest_document_type: payload.guest_document_type || null,
      guest_document_number: payload.guest_document_number?.trim() || null,
